...
package com.arturmaslov.miniplazma.service;
...
import com.arturmaslov.miniplazma.events.GrblRealTimeCommandEvent;
import com.arturmaslov.miniplazma.events.UiToastEvent;
import com.arturmaslov.miniplazma.helpers.NotificationHelper;
import com.arturmaslov.miniplazma.listeners.SerialBluetoothCommunicationHandler;
...
public class GrblBluetoothSerialService extends Service {
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread(boolean secure) {
            ...
            if (ActivityCompat.checkSelfPermission(GrblBluetoothSerialService.this, Manifest.permission.BLUETOOTH_CONNECT) == PackageManager.PERMISSION_GRANTED) {
                try {
                    if (secure) {
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            if (ActivityCompat.checkSelfPermission(GrblBluetoothSerialService.this, Manifest.permission.BLUETOOTH_SCAN) == PackageManager.PERMISSION_GRANTED) {
